        ...
        <div class="col-md-12">
            <div class="shadow-lg" style="border-radius: 40px 40px 40px 40px;">
                <div class="border border-secondary p-2" style="border-radius: 40px 40px 0px 0px; background-color:#00b7ff">
                    <h6 class="ms-2 my-0" style="color:white">Cardiologie / Programare: {{ $programare->nume }} / Referat medical</h6>
                </div>
                ...
                >
                    <form  class="needs-validation" novalidate method="POST" action="{{ $programare->path() }}/referat-medical">
