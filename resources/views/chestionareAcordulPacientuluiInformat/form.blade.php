    ...
    <div class="col-lg-12 mb-0">
        ...
        <div class="row mb-4 rounded-3" style="border:1px solid #e9ecef; border-left:0.25rem darkcyan solid">
            ...
            <div class="col-lg-12 ps-5 align-items-left">
                <div class="row">
                    <div class="col-md-auto">
                        <label for="alergic_la" class="col-form-label">1.1. Nume și prenume:</label>
                    </div>
                    <div class="col">
                        <input
                            type="text"
            ...
            <div class="col-lg-12 ps-5 align-items-left">
                <div class="row">
                    <div class="col-md-auto">
                        <label for="intoleranta_la" class="col-form-label">1.2. Domiciliu/reședință:</label>
                    </div>
                    <div class="col">
                        <input
                            type="text"
        ...
        <div class="row mb-4 rounded-3" style="border:1px solid #e9ecef; border-left:0.25rem #e66800 solid">
            ...
            <div class="col-lg-12 ps-5 align-items-left">
                <div class="row">
                    <div class="col-md-auto">
                        <label for="alergic_la" class="col-form-label">2.1. Nume și prenume:</label>
                    </div>
                    <div class="col">
                        <input
                            type="text"
            ...
            <div class="col-lg-12 ps-5 align-items-left">
                <div class="row">
                    <div class="col-md-auto">
                        <label for="intoleranta_la" class="col-form-label">2.2. Domiciliu/reședință:</label>
                    </div>
                    <div class="col">
                        <input
                            type="text"
            ...
            <div class="col-lg-12 ps-5 align-items-left">
                <div class="row">
                    <div class="col-md-auto">
                        <label for="alergic_la" class="col-form-label">2.3. Calitate:</label>
                    </div>
                    <div class="col">
                        <input
                            type="text"
        ...
        <div class="row mb-4 rounded-3" style="border:1px solid #e9ecef; border-left:0.25rem darkcyan solid">
            <div class="col-md-auto">
                <label for="intoleranta_la" class="col-form-label">3. Actul medical<br>(descriere)</label>
            </div>
            <div class="col">
                <textarea
                    id="intoleranta_la"
        ...
        <div class="row mb-4 rounded-3 align-items-center" style="border:1px solid #e9ecef; border-left:0.25rem #e66800 solid">
            <div class="col-lg-12 mb-2 d-flex align-items-left">
